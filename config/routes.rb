...
#Rails::application::routes.draw do |map|
  ...
  match 'settings/show_multiple_trackers_custom_fields' => 'settings#show_multiple_trackers_custom_fields', via: [:get, :post]
  match 'settings/show_income_expense_types' => 'settings#show_income_expense_types', via: [:get, :post]
